    ...
    return(
        <div className='contenedor-form'>
            <form onSubmit={handleSubmit}>
                ...
                <input id='email' type="email" name="email" placeholder="Ingrese su correo" className='campo' required />

                <label htmlFor='direccion' >Dirección</label>
                <input id='direccion' type="text" name="direccion" placeholder="Ingrese su dirección" className='campo' required />

                <label htmlFor='telefono' >Telefono</label>
                <input id='telefono' type="tel" name="telefono" placeholder="Ingrese su numero de telefono" className='campo' required />
